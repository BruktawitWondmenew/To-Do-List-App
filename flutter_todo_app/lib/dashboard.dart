    ...
    try {
      ...
      if (jsonResponse['status'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Failed to add todo: ${jsonResponse['message'] ?? 'Unknown error'}')),
        );
      }
    } catch (e) {
    ...
    try {
      ...
      if (jsonResponse['status'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Failed to update todo: ${jsonResponse['message'] ?? 'Unknown error'}')),
        );
      }
    } catch (e) {
    ...
    try {
      ...
      if (jsonResponse['status'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Failed to delete todo: ${jsonResponse['message'] ?? 'Unknown error'}')),
        );
      }
    } catch (e) {
